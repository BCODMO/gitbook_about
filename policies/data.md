...
The BCO-DMO repository provides mid-term data assembly and curation infrastructure. As a grant-sponsored project, BCO-DMO is subject to terms, conditions, and uncertainties associated with grant funding. To ensure sustainability of the repository's data catalog and associated project information, BCO-DMO implements a multiple, redundant, long-term preservation strategy to ensure continuity of data access, should the repository suddenly cease operations. Data packages that have been published with DOIs at BCO-DMO get deposited in the WHOI MBL Institutional Library's Open Access Server (WHOAS). Additionally, these same data packages are harvested by NOAA's National Centers for Environmental Information (NCEI) for inclusion in NCEI's archive. Lastly, A copy of all data packages, including legacy data for which DOIs have not been assigned, are submitted to the Internet Archive for long-term preservation.&#x20;

The project continuously strives to develop and implement automated workflows and emerging technologies, including AI, to streamline operations, reduce costs, and build a more modular, resilient system. In the process, the infrastructure serves as a research and development platform for informatics research, helping to improve data reuse and accelerate time to science.
